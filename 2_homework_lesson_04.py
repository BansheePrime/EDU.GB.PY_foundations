...
# print(currency_rus_name)
# print(currency_nominal)
# print(currency_abbreviation)
...
# readable_list = zip(currency_abbreviation, currency_rus_name, currency_nominal, currency_value)
# print(tuple(readable_list))



# size_new_list = len(new_list)
# better_list = [id + 1 for id, val in
#             enumerate(new_list) if val == 'Valute']
#
# result_list = [new_list[k: l] for k, l in
#        zip([0] + better_list, better_list +
#            ([size_new_list] if better_list[-1] != size_new_list else []))]

# print result
# print("After splitting: " + str(result_list))
# size_better_list = len(result_list)
# print(size_better_list)
# clearing_indices = [ 6, 9, 12, 15]
# clear_result = [result_list[p] for p in clearing_indices]
